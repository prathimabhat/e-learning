...
urlpatterns = [
    ...
    path('add_subject/<int:session_year>/<int:course>/', views.add_subject, name="add_subject"),
    ...
    path('select_action_subject/<int:session_year>/',views.select_action_subject,name="select_action_subject"),
    path('manage_subject/<int:course>/', views.manage_subject, name="manage_subject"),
    path('add_students_subject/<int:subject_id>/',views.add_students_subject,name="add_students_subject"),
    path('remove_students_subject/<int:subject_id>/', views.remove_students_subject, name="remove_students_subject"),
    ...
    path('select_semester_student/',views.select_semester_student,name="select_semester_student"),
    ...
    path('select_semester_subject/',views.select_semester_subject,name="select_semester_subject"),
    path('edit_student_save/<int:student_id>/', views.edit_student_save, name="edit_student_save"),
    ...
    path('save_student_result/<int:student_id>/<int:subject_id>/', views.save_student_result, name="save_student_result"),
    ...
    path('edit_student_result/<int:student_id>/<int:subject_id>/', views.edit_student_result, name="edit_student_result"),
    path('edit_student_result_save/<int:student_id>/<int:subject_id>/', views.edit_student_result_save, name="edit_student_result_save"),
    path('staff_manage_result', views.staff_manage_result, name="staff_manage_result"),
    path('staff_add_result_save/<int:student_id>/<int:subject_id>/', views.staff_add_result_save, name="staff_add_result_save"),
    path('select_session_year', views.select_session_year, name="select_session_year"),
